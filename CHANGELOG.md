...
### Added
- Add global forecasting and spherical domain support with coordinate conversion primitives and cosine-latitude spatial area-weighted metrics [\#650](https://github.com/mllam/neural-lam/issues/650) @GiGiKoneti
